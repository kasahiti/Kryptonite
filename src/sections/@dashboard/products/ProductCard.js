...
export default function CocktailProductCard({product}) {
    ...
    return (
        <>
            <Card>
                ...
                <Stack spacing={2} sx={{p: 3, "&:hover": {cursor: "pointer"}}} direction="row"
                    ...
                    <FavoriteIcon sx={{color: colorButton, "&:hover": {color: "green", cursor: "pointer"}}}
